CREATE PROCEDURE UpdateStockData
    @ticker VARCHAR(10),
...
BEGIN
    ...
    BEGIN
        ...
        VALUES (@ticker, @company_name, @open_price, @high_price, @low_price, @price, @volume, @latest_trading_day, @change_amount, @change_percent, GETDATE());
    END
END;
